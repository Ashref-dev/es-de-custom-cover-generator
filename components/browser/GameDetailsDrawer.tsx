  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      if (changesMade > 0) {
        ...
        for (const mediaType of MEDIA_TYPES) {
          if (editableMediaFiles[mediaType.key]) {
            // If this file was just updated
            const handleName = mediaKeyToGameHandle[mediaType.key];
            if (handleName) {
              ...
              if (fileHandle) {
                if (
                  urls[mediaType.key] &&
                  urls[mediaType.key].startsWith("blob:")
                ) {
                            ...
                            currentUrl ? ( // If currentUrl is a blob URL (truthy)
                              ...
                              <div className="flex items-center justify-center h-full flex-col text-center px-4">
                                ...
                                <div className="text-xs text-muted-foreground mt-1">
                                  Preview could not be loaded. File might be
        ...
        <SheetFooter className="p-6 border-t border-border/40 bg-background z-10 flex-shrink-0 mt-auto">
          <div className="max-w-7xl mx-auto w-full flex justify-between items-center gap-4">
            ...
            <Button
              ...
              disabled={
                isSaving ||
                Object.keys(editableMediaFiles).every(
